...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db, ConnectionSource connectionSource) {
        ...
        try {
            ...
            route.setType(WorkoutIntensivity.CARDIO);
...
//        try {
//            routetDao = getRouteDao();
//            UpdateBuilder<Route, Integer> updateBuilder = routetDao.updateBuilder();
//            updateBuilder.updateColumnValue("type", "CARDIO");
